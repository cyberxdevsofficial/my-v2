...
const config = {
    ...
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: 'ᴀɴᴜᴡʜ ᴍɪɴɪ ᴍᴅ ʙᴇᴛᴀ',
    OWNER_NAME: 'ᴀɴᴜɢᴀ sᴇɴɪᴛʜᴜ',
    OWNER_NUMBER: '94710695082',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> © 𝐏ᴏᴡᴇʀᴇᴅ 𝐁ʏ 𝐀ɴᴜɢᴀ 𝐒ᴇɴɪᴛʜᴜ',
...
┗━━━━━━━━━━━━━━━━━━┛
   ...
   ⦁ *ʙᴏᴛ ᴏᴡɴᴇʀ*: ᴀɴᴜɢᴀ sᴇɴɪᴛʜᴜ
   ⦁ *ᴠᴇʀꜱɪᴏɴ*: ᴠ1 ʙᴇᴛᴀ
   ⦁ *ᴘʟᴀᴛꜰᴏᴇᴍ*: ᴀɴᴜɢᴀ sᴇɴɪᴛʜᴜ's ᴘʀɪᴠᴀᴛᴇ ᴠᴘs | ᴜʙᴜɴᴛᴜ 22.04
...
//=======================================
                ...
                case 'owner': {
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        caption: '*ᴀɴᴜᴡʜ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ*',
                        buttons: [
    ...
    const title = '*ᴀɴᴜᴡʜ ᴍᴅ ᴍɪɴɪ ꜱʏꜱᴛᴇᴍ*';
    const content = `┏━━━━━━━━━━━━━━━━\n` +
...
await socket.sendMessage(userJid, {
    ...
    caption: formatMessage(
        ...
        'ᴀɴᴜɢᴀ sᴇɴɪᴛʜᴜ'
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'ᴀɴᴜᴡʜ ᴍᴅ ᴍɪɴɪ'}`);
                }
            }
        });
    } catch (error) {
